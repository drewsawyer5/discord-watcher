...
CODEX_HEARTBEAT_INTERVAL_SECONDS=60
```
...
While a Codex turn is running, the bridge sends periodic heartbeat messages based on the saved Codex session JSONL file. Set `CODEX_HEARTBEAT_INTERVAL_SECONDS=0` to disable the heartbeat.
